...
/**
 * Local cache of Stripe products and subscription pricing + app-managed plan configuration.
 *
...
export const stripePlan = pgTable("stripe_plan", {
  ...
  // ---- Synced pricing variants ----
  annualDiscountPriceId: text("annual_discount_price_id"), // Stripe price ID for annual billing variant
  lookupKey: text("lookup_key"), // Primary Stripe price lookup key (alternative to priceId)
