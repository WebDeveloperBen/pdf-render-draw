...
- [x] We need to enable printing of the pdf's with annotations embedded e.g. a download link
- [x] We need to enable download of the original file without annotations
